...
export default function PersonalProgress() {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 bg-gray-900 rounded-2xl p-6 border border-blue-500/20">
    ...
    <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 bg-gray-900 rounded-2xl p-6 border border-blue-500/20">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-300">Track your personal goals</p>
        </div>
        ...
        <div className="pt-3 border-t border-gray-700">
          <div className="grid grid-cols-2 gap-4 text-center">
            <div>
              ...
              <p className="text-xs text-gray-300">Year Points</p>
              <p className="text-xs text-gray-400">{stats.yearPoints}/{stats.yearGoal}</p>
            </div>
            <div>
              <p className="text-2xl font-black text-green-400">
                {calculatePercentage(stats.yearItems, stats.yearItemGoal)}%
              </p>
              <p className="text-xs text-gray-300">Year Items</p>
              <p className="text-xs text-gray-400">{stats.yearItems}/{stats.yearItemGoal}</p>
            </div>
          </div>
        </div>
      </div>
