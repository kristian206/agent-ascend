...
export default function MetricsDashboard() {
  ...
  if (loading) {
    return (
      <div className="bg-gray-800/50 bg-gray-900 rounded-2xl border border-gray-700 p-8">
    ...
    <div className="bg-gray-800/50 bg-gray-900 rounded-2xl border border-gray-700 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 p-4 rounded-xl border border-blue-500/30">
          <div className="text-sm text-gray-300 mb-1">Total Points</div>
        ...
        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-4 rounded-xl border border-purple-500/30">
          <div className="text-sm text-gray-300 mb-1">Conversion Rate</div>
        ...
        <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-4 rounded-xl border border-yellow-500/30">
          <div className="text-sm text-gray-300 mb-1">Check-ins</div>
          <div className="text-3xl font-black text-yellow-400">
            {metrics?.morningCheckIns || 0} / {metrics?.eveningCheckIns || 0}
          </div>
          <div className="text-xs text-gray-400 mt-1">Morning / Evening</div>
        </div>

        <div className="bg-gradient-to-br from-red-500/20 to-pink-500/20 p-4 rounded-xl border border-red-500/30">
          <div className="text-sm text-gray-300 mb-1">Quotes Submitted</div>
        ...
        <div className="bg-gradient-to-br from-indigo-500/20 to-blue-500/20 p-4 rounded-xl border border-indigo-500/30">
          <div className="text-sm text-gray-300 mb-1">Best Day</div>
          ...
          {Object.entries(POLICY_TYPES).map(([key, type]) => {
            ...
            return (
              <div key={key} className="text-center">
                ...
                <div className="text-xs text-gray-400">{percentage}% of sales</div>
                <div className="text-xs text-gray-400">{data.points} pts</div>
              </div>
            )
          })}
        </div>
