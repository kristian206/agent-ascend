...
import { joinTeam } from '@/src/utils/teamUtils'
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-4 text-center text-2xl font-mono tracking-wider rounded-xl bg-gray-800 border border-gray-600 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 uppercase"
              placeholder="ABC123"
              maxLength={6}
              required
            />
          ...
          {teamPreview && (
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              {teamPreview.description && (
                <p className="text-gray-200 text-sm mt-1">{teamPreview.description}</p>
              )}
