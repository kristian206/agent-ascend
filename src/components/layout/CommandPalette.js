...
export default function CommandPalette({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div 
        className="fixed inset-0 bg-ink-900/20 bg-gray-900 z-40"
        onClick={onClose}
      />
        ...
        <div className="glass-xl rounded-xl elev-4 overflow-hidden">
          ...
          <div className="p-4 border-b border-ink-100">
            <div className="flex items-center gap-3">
              ...
              />
              <kbd className="px-2 py-1 rounded bg-gray-750 type-detail-caption text-ink-400">
                ESC
              </kbd>
            </div>
          </div>
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${selectedIndex === index 
                        ...
                        : 'hover:bg-gray-800 text-ink-700'
                      }
                    `}
                  >
                    ...
                    {item.shortcut && (
                      <kbd className="px-2 py-1 rounded bg-gray-750 type-detail-caption text-ink-400 flex-shrink-0">
                        {item.shortcut}
                      </kbd>
                    )}
                    {item.type === 'nav' && (
          ...
          <div className="px-4 py-3 border-t border-ink-100 flex items-center justify-between">
            <div className="flex gap-4 type-detail-caption text-ink-400">
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded bg-gray-750">↑↓</kbd>
                Navigate
              </span>
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded bg-gray-750">↵</kbd>
              ...
              <span className="flex items-center gap-1">
                <kbd className="px-1 rounded bg-gray-750">ESC</kbd>
                Close
              </span>
            </div>
          </div>
