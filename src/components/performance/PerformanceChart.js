  ...
  return (
    <div className="bg-gray-800/50 bg-gray-900 rounded-2xl border border-gray-700 p-6">
      ...
      <div className="relative">
        <div className="absolute left-0 top-0 text-xs text-gray-400">{maxValue}</div>
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="text-center">
          ...
          <div className="text-xs text-gray-300">Total {getLabel()}</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-white">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-gray-300">Best Day</div>
        </div>
      </div>
    </div>
  )
