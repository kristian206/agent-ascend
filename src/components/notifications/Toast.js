...
export default function Toast({ notification, onClose, duration = 5000 }) {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700 p-4 min-w-[320px] max-w-md">
        <div className="flex items-start gap-3">
          ...
          <button
            onClick={handleClose}
            className="text-gray-300 hover:text-white transition ml-2"
          >
