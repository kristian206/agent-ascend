        ...
        <div className="min-h-[400px] flex items-center justify-center p-8">
          <div className="max-w-md w-full">
            <div className="glass-error radius-xl p-8 text-center">
              ...
              <p className="type-list-body text-secondary mb-6">
                {area === 'component' 
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="mb-6 text-left">
                  <summary className="type-detail-caption text-tertiary cursor-pointer hover:text-secondary">
                    Error Details (Development Only)
                  </summary>
                  <div className="mt-2 p-3 bg-surface-100 rounded-lg">
                    <p className="type-detail-mono text-error text-xs break-all">
                      {this.state.error.toString()}
                    </p>
                    {this.state.errorInfo && (
                      <pre className="mt-2 type-detail-mono text-tertiary text-xs overflow-auto max-h-40">
